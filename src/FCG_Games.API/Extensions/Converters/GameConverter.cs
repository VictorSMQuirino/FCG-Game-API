...
public static class GameConverter
{
	public static CreateGameDto ToDto(this CreateGameRequest request)
		=> new(request.Title, request.Description, request.Developer, request.Publisher, request.Price, request.ReleaseDate);
	...
	public static GetGameByIdResponse ToResponse(this GameDto dto)
		=> new(dto.Id, dto.Title, dto.Description, dto.Developer, dto.Publisher, dto.Price, dto.ReleaseDate);
